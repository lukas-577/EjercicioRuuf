// encontrar la maxima cantidad de rectangulos que se pueden formar con una cantidad de cuadrados
...
console.log("caben:"+maxPanelesEnTecho(1,2,3,5));
console.log("caben:"+maxPanelesEnTecho(2,2,1,10));
console.log("caben:"+maxPanelesEnTecho(2,2,2,4));
console.log("caben:"+maxPanelesEnTecho(2,2,1,15));
